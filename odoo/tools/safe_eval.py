...
class _SafeChecker:
    ...
    def __init__(self):
        ...
        # Add hooks
        [self.add_hook(t, None) for t in _SafeWhitelist.TRUSTED_TYPES]  # Optimization to save time when serializing these types
        [self.add_hook(t, list) for t in self.SEQUENCES]
        [self.add_hook(t, dict) for t in self.MAPPINGS]
