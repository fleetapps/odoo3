...
class ProductTemplate(models.Model):
    ...
    def _compute_volume(self):
        for t in self:
            t.volume = t.product_variant_ids.volume if t.product_variant_count == 1 else t.volume
    ...
    def _compute_weight(self):
        for t in self:
            t.weight = t.product_variant_ids.weight if t.product_variant_count == 1 else t.weight
