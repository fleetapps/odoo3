...
class AccountMove(models.Model):
    ...
    def _can_process_sending_event(self, event_code, sending_methods):
        res = super()._can_process_sending_event(event_code, sending_methods)
        if 'nemhandel' in sending_methods and event_code == 'account_move_send':
            return res and self.nemhandel_move_state == 'to_send'
        return res
