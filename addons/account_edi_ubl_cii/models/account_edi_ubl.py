...
class AccountEdiUBL(models.AbstractModel):
    ...
    def _import_ubl_invoice_line_add_taxes_values(self, collected_values):
        ...
        for node in line_tree.findall('.//{*}Item/{*}ClassifiedTaxCategory'):
            ...
            if partner and (name := collected_values['to_write']['name']):
    ...
    def _import_ubl_invoice_add_invoice_line_values(self, collected_values):
        ...
        for xpath in ('./{*}InvoiceLine', './{*}CreditNoteLine', './{*}DebitNoteLine'):
            for line_tree in tree.iterfind(xpath):
                ...
                invoice_line_ids.append(Command.create(line_collected_values['to_write']))
    ...
    def _import_ubl_invoice_retrieve_taxes(self, collected_values):
        ...
        for invoice_line_values in invoice_lines_values:
            tax_values_list += invoice_line_values['taxes_values']
        ...
        for invoice_line_values in invoice_lines_values:
            to_write = invoice_line_values['to_write']
