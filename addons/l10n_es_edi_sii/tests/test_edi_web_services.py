...
class TestEdiWebServices(TestEsEdiCommon):
    ...
    def test_edi_gipuzkoa(self):
        ...
        with patch('odoo.addons.l10n_es_edi_sii.models.l10n_es_edi_sii_document.L10nEsEdiSiiDocument._post_to_agency', autospec=True) as mock_post:
            mock_post.side_effect = lambda doc_self, header, info_list: (True, {'csv': 'MOCK_CSV', 'response_message': 'Correcto'})
