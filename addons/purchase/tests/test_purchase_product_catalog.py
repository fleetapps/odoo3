...
class TestPurchaseProductCatalog(AccountTestInvoicingCommon, HttpCase):
    ...
    def test_catalog_price(self):
        ...
        uom_conversion_ratio = purchase_order.order_line[0]._get_product_catalog_lines_data()['uomConversion']
        self.assertEqual(resp, other_product_price_converted * 6)
        self.assertEqual(resp * uom_conversion_ratio, other_product_price_converted)  # Price in product unit
