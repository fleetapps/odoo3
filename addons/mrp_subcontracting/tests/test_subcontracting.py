...
class TestSubcontractingBomCost(TestBomCostCommon):
    ...
    def test_01_compute_price_subcontracting_cost(self):
        ...
        self.assertEqual(float_round(self.bom_1.unit_cost, precision_digits=2), 500.0, "The cost computed from the BoM should be 500.0")
        ...
        self.assertEqual(float_compare(self.bom_2.unit_cost, 328.75, precision_digits=2), 0, "The cost computed from the BoM should be 328.75")
        self.assertEqual(float_compare(self.bom_1.unit_cost, 528.75, precision_digits=2), 0, "The cost computed from the BoM should be 528.75")
