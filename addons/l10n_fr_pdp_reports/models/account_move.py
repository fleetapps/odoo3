...
class AccountMove(models.Model):
    ...
    l10n_fr_pdp_display_info = fields.Boolean(related='company_id.l10n_fr_pdp_enabled')
    ...
    def _compute_l10n_fr_pdp_status(self):
        for move in self:
            ...
            relevant_flow = next(
                (flow for flow in sorted_flows if flow.state not in {'sent', 'completed'}),
                False,
            ) or sorted_flows[0]
    ...
    def _get_l10n_fr_pdp_transaction_type(self):
        ...
        #
        #
        # TODO this method is useless if we keep drom_com_territories utils
        #
        #
        #
        #
        ...
        if 'is_move_sent' in vals:
            ...
            if affected:
                ...
                if flows:
                    ...
                    except UserError: # TODO  ? Why try except ? UserError enough ???
