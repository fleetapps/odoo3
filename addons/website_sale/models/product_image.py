...
class ProductImage(models.Model):
    ...
    def _onchange_video_url(self):
        # invalidate the thumbnail image if the video URL is changed to avoid keeping an old thumbnail
        # todo check if this is necessary since the new thumbnail mechanism
        if self.image_1920:
