...
export class PickupLocationMany2OneField extends Many2OneField {
    ...
    async setup() {
        ...
        const relatedPartnerId = this.props.record.data.partner_id.id;
        const relatedPartner = await this.orm.read("res.partner", [relatedPartnerId]);
        this.countryId = relatedPartner[0].country_id[0];
    }
