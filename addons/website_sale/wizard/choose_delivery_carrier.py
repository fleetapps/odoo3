...
class ChooseDeliveryCarrier(models.TransientModel):
    ...
    def _onchange_carrier_id(self):
        ...
        if self.partner_shipping_id.pickup_delivery_method_id and self.partner_shipping_id.pickup_delivery_method_id.id != self.carrier_id.id:
            self.partner_shipping_id = self.partner_id

    def button_confirm(self):
        if self.is_pickup_required and self.partner_shipping_id.pickup_delivery_method_id.id != self.carrier_id.id:
