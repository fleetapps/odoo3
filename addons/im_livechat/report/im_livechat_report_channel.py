...
class Im_LivechatReportChannel(models.Model):
    ...
    rating = fields.Selection(selection=[
        ...
        ("3", "Neutral"),
        ("5", "Happy"),
    ], string='Satisfaction Rate', required=True, readonly=True)
    rating_value = fields.Integer('Rating', aggregator="avg", readonly=True)
    ...
    def _select(self) -> SQL:
        return SQL(
            ...
            SELECT
                ...
                NULLIF(C.livechat_rating::integer, 0) as rating_value,
