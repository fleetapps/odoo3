...
class MrpProduction(models.Model):
    ...
    note = fields.Html(string="Additional Notes", compute='_compute_note', store=True, help="Additional Notes for the manufacturing order. Notes added here will be displayed in Shop Floor also.")
