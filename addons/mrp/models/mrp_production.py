...
class MrpProduction(models.Model):
    ...
    def _update_order_line_info(self, product, quantity, uom=False, *, child_field=False, **kwargs):
        ...
        if entity:
            ...
            new_line_vals = self._get_new_catalog_line_values(product.id, quantity, uom=uom, child_field=child_field, **kwargs)
    ...
    def _get_new_catalog_line_values(self, product_id, quantity, uom=False, **kwargs):
