...
class TestBomCost(TestBomCostCommon):
    ...
    def test_01_compute_price_operation_cost(self):
        ...
        self.assertEqual(float_round(self.bom_1.unit_cost, precision_digits=2), 388.60)
        ...
        self.assertEqual(float_compare(self.bom_1.unit_cost, 411.56, precision_digits=2), 0)
