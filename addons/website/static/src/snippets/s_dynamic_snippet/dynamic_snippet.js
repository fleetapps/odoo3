...
export class DynamicSnippet extends Interaction {
    ...
    async fetchData() {
        if (this.isConfigComplete()) {
            ...
            const filterFragments = await this.waitFor(this.dynamicSnippetRpc(
...
export const DynamicSnippetCached = (I) =>
    class extends I {
        setup() {
            super.setup();
            this.dynamicSnippetRpc = (url, params) =>
                this.services.website_edit.interactionRpc({ ...params, url });
        }
    };
