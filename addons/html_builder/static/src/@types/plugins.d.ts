declare module "plugins" {
    ...
    import { builder_header_middle_buttons, builder_options, BuilderOptionsShared, on_current_options_containers_changed_handlers, clone_disabled_reason_providers, container_title, elements_to_options_title_components, options_container_top_buttons_providers, has_overlay_options, should_keep_overlay_options_predicates, no_parent_containers, on_target_revealed_handlers, reveal_target_destination_processors, remove_disabled_reason_providers } from "@html_builder/core/builder_options_plugin";
    ...
    import { on_device_view_switched_handlers } from "@html_builder/core/mobile_preview_plugin";
    ...
    import { editor_enabled_handlers, is_element_hidden_predicates, lower_panel_entries, on_dom_updated_handlers } from "@html_builder/builder";
    ...
    export interface BuilderResourcesList {
        ...
        on_device_view_switched_handlers: on_device_view_switched_handlers;
        ...
        is_element_hidden_predicates: is_element_hidden_predicates;
