...
registry.category("web_tour.tours").add('website_profile_description_mobile', {
    ...
    steps: () => [{
        ...
        content: "Edit profile",
        trigger: "a:contains('EDIT') i.fa.fa-pencil",
        run: "click",
    }, {
        content: "Add some content",
        trigger: ".odoo-editor-editable",
        run: "editor content <p>mobile code here</p>",
    }, {
        content: "Save changes",
        trigger: "button:contains('Update')",
        run: "click",
        ...
        content: "Check the content is saved",
        trigger: "span[data-oe-field='website_description']:contains('content <p>mobile code here</p>')",
    }]
})
