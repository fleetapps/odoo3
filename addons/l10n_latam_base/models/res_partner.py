...
class ResPartner(models.Model):
    ...
    def _run_check_identification(self, validation='error'):
        for partner in self:
            if partner.country_id and partner.l10n_latam_identification_type_id.country_id and partner.l10n_latam_identification_type_id.country_id != partner.country_id:
                raise ValidationError(_('The indentification type must match the partner country.'))
