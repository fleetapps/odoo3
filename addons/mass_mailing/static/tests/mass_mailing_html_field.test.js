...
describe("field HTML", () => {
    ...
    test("switch out from a notebook tab with html field should update the record", async () => {
        ...
        // wait for conversion of the existing html content
        await htmlField.converter.getUnlockedDef();
        ...
        // simulate focus in the edition area
        htmlField.activeElement = htmlField.iframeWrapperRef.el;
        ...
        await waitFor(".o_field_widget[name='body_html'] .o_readonly:empty", {
            timeout: 3000,
        });
        resumeConversion();
        expect(
