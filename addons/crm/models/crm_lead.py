...
class CrmLead(models.Model):
    ...
    company_currency = fields.Many2one("res.currency", string='Currency', compute="_compute_company_currency", compute_sudo=True, store=True)
    # Dates
    ...
    def _compute_company_currency(self):
        ...
        for company, leads in self.grouped("company_id").items():
            leads.company_currency = (company or user_company).currency_id
