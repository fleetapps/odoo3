...
import { TRANSLATABLE_PROPERTY_LABELS, TranslateUiSidePanel } from "./translate_ui_side_panel";
...
export class TranslateUiService {
    ...
    destroy() {
        ...
        registry.category("main_components").remove("translate-ui-side-panel");
    ...
    registerSidePanel() {
        registry.category("main_components").add("translate-ui-side-panel", {
            Component: TranslateUiSidePanel,
            props: {
...
export const translateUiServiceFactory = {
    dependencies: ["localization", "orm"],
    start(env, dependencies) {
        const service = new TranslateUiService();
...
if (window === window.top) {
    registry.category("services").add("translate_ui", translateUiServiceFactory);
}
