...
/**
 * @typedef {import("./translate_ui_service").TargetedTranslation} TargetedTranslation
 */
...
export class TranslateUiSidePanel extends Component {
    static props = {
        translations: {
            type: Array,
            element: {
    ...
    static template = "translate_ui.TranslateUiSidePanel";
    ...
    setup() {
        ...
        this.translateUi = useService("translate_ui");

        this.translateUi.useBodyClass("o-body-with-translate-side-panel");
        ...
        this.orm
            .call("ir.config_parameter", "get_str", ["translate_ui.translate_url"])
            .then((translationUrl) => {
    ...
    onCardClick(translation, ev) {
        ...
        this.translateUi.highlightTranslation(translation, ev.ctrlKey);
    }
    ...
    openSettings() {
        this.actionService.doAction({
            ...
            name: "Settings",
            res_model: "translate_ui.settings",
            views: [[false, "form"]],
            target: "new",
        });
    }
