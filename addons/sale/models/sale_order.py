...
class SaleOrder(models.Model):
    ...
    amount_to_invoice = fields.Monetary(string="Un-invoiced Balance", store=True, compute='_compute_amount_to_invoice')
    amount_invoiced = fields.Monetary(string="Already invoiced", store=True, compute='_compute_amount_invoiced')
