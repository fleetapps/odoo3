    ...
    def _compute_edi_error_count(self):
        ...
        for move in self:
            if (
                ...
                and move.edi_document_ids and all(
                    d.edi_format_id.code in ["in_einvoice_1_03", "in_ewaybill_1_03"] and d.state in ("to_send", "sent") and not d.blocking_level
                    for d in move.edi_document_ids
                    )
