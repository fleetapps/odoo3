...
class ProductTemplate(models.Model):
    ...
    def write(self, vals):
        ...
        lot_ids_to_update.update(self.env['stock.lot'].search([
        ...
        if lot_ids_to_update:
            self.env['stock.lot'].browse(lot_ids_to_update)._update_standard_price()
        return res
...
class ProductCategory(models.Model):
    ...
    def write(self, vals):
        ...
        if products_lot_valuated:
            self.env['stock.lot'].search([('product_id', 'in', products_lot_valuated.ids)])._update_standard_price()
        return res
