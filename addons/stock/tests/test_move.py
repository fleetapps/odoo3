...
class StockMove(TransactionCase):
    ...
    def test_aggregated_quantities_partial_and_over_delivery(self):
        ...
        aggregated = next(
            iter(delivery.move_line_ids._get_aggregated_product_quantities().values())
        )
        self.assertEqual(aggregated['qty_ordered'], 10)
        self.assertEqual(aggregated['quantity'], 6)
        # -------------------------
        # Over-delivery (12 / 10)
        # -------------------------
        ...
        self.assertEqual(aggregated['qty_ordered'], 10)
        self.assertEqual(aggregated['quantity'], 12)
