...
export class DynamicSnippetBlogsCarousel extends BlogPostsCarouselBase {
    static selector = ".s_blog_posts_carousel";
}

registry
    .category("public.interactions")
    .add("website_blog.blog_posts_carousel", DynamicSnippetBlogsCarousel);
...
registry.category("public.interactions.edit").add("website_blog.blog_posts_carousel", {
    Interaction: DynamicSnippetBlogsCarousel,
});
